    ...
    <div className='Roboto'>
      ...
      <div className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen p-8">
        <div className="container mx-auto max-w-4xl">
          ...
          {/* Header Section */}
          <div className="bg-white dark:bg-gray-800 shadow-sm rounded-t-md p-6 mb-2">
            <div className="flex justify-between items-center">
              <div className="text-4xl font-bold text-gray-900 dark:text-white uppercase">Sagar Suri</div>
              <div className="text-right">
                <p className="text-sm text-gray-600 dark:text-gray-400"><i className="fas fa-phone-alt mr-2"></i>+918806116794</p>
                <p className="text-sm text-gray-600 dark:text-gray-400"><i className="fas fa-envelope mr-2"></i><a href="mailto:sagrsurigmail.com" className="hover:underline">sagrsurigmail.com</a></p>
                <p className="text-sm text-gray-600 dark:text-gray-400"><i className="fas fa-globe mr-2"></i><a href="https://www.sagarsuri.in" className="hover:underline" target="_blank" rel="noreferrer">www.sagarsuri.in</a></p>
                <p className="text-sm text-gray-600 dark:text-gray-400"><i className="fab fa-github mr-2"></i><a href="https://github.com/sagrsuri" className="hover:underline" target="_blank" rel="noreferrer">github.com/sagrsuri</a></p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 border-x-[1px] border-[#858585] p-6 mb-0" style={{ marginTop: '0px' }}>
